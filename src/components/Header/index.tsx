                    ...
                    {menuData.map((menuItem, index) => (
                      <li key={index} className="group relative">
                        {menuItem.path ? (
                          <Link
                            href={menuItem.path}
                            className={`flex py-2 text-lg font-semibold lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 ${usePathName === menuItem.path
                          ...
                          <>
                            <p
                              ...
                              className="flex cursor-pointer items-center justify-between py-2 text-lg font-semibold text-dark group-hover:text-primary dark:text-white/70 dark:group-hover:text-white lg:mr-0 lg:inline-flex lg:px-0 lg:py-6"
                            >
                              {menuItem.title}
                              <span className="pl-3">
                            ...
                            >
                              {menuItem.submenu.map((submenuItem, index) => (
                                <Link
                                  ...
                                  key={index}
                                  className="block rounded py-2.5 text-base font-medium text-dark hover:text-primary dark:text-white/70 dark:hover:text-white lg:px-3"
                                >
                                  {submenuItem.title}
                                </Link>
                              ))}
